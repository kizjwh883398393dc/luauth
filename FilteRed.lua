...
function obfuscate(source,VarName,WaterMark)
    ...
    if typeof(WaterMark) == "string" and WaterMark ~= nil then
        WM = "    "..tostring(WaterMark).." The Script has been protected by Filtered v1.0.1"
    else
        WM = "    ".."WaterMark".." The Script has been protected by Filtered v1.0.1"
    end
